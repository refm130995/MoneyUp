...
import { BranchesOffiicesService } from '../../services/Branch/branches-offiices.service';
declare var google;
...
export class NearByPage implements OnInit {
  ...
  constructor(
    ...
    private branches: BranchesOffiicesService,
  ...
  getBranch() {
    this.present();
    this.branches.getBranch().subscribe(res => {
        console.log(res);
        this.salonList = res;
        this.dismiss();
      },
  ...
  getBranchId() {
    this.present();
    this.branches.getBranchId().subscribe(res => {
        console.log(res);
        this.salonList = res;
        this.dismiss();
      },
